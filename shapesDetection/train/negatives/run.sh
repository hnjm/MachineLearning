...
#opencv_createsamples -img ../positives/img/*.png -info ./annotations.lst -vec ./samples_output.vec -bg ./bg.txt -maxxangle 0.1 -maxyangle 0.1 -maxzangle 0.1 -num ${NUM_POS} -w ${W} -h ${H} \
